// Generated by gencpp from file gpg/GraspConfig.msg
// DO NOT EDIT!


#ifndef GPG_MESSAGE_GRASPCONFIG_H
#define GPG_MESSAGE_GRASPCONFIG_H
...
struct GraspConfig_
{
  ...
  typedef boost::shared_ptr< ::gpg::GraspConfig_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gpg::GraspConfig_<ContainerAllocator> const> ConstPtr;

}; // struct GraspConfig_

typedef ::gpg::GraspConfig_<std::allocator<void> > GraspConfig;

typedef boost::shared_ptr< ::gpg::GraspConfig > GraspConfigPtr;
typedef boost::shared_ptr< ::gpg::GraspConfig const> GraspConfigConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::gpg::GraspConfig_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::gpg::GraspConfig_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::gpg::GraspConfig_<ContainerAllocator1> & lhs, const ::gpg::GraspConfig_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::gpg::GraspConfig_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::gpg::GraspConfig_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gpg::GraspConfig_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::gpg::GraspConfig_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gpg::GraspConfig_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::gpg::GraspConfig_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::gpg::GraspConfig_<ContainerAllocator> >
{
  ...
  static const char* value(const ::gpg::GraspConfig_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8753a773793263efULL;
  static const uint64_t static_value2 = 0x11dce97fd6d996d5ULL;
};

template<class ContainerAllocator>
struct DataType< ::gpg::GraspConfig_<ContainerAllocator> >
{
  static const char* value()
  {
    return "gpg/GraspConfig";
  }
...
template<class ContainerAllocator>
struct Definition< ::gpg::GraspConfig_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::gpg::GraspConfig_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::gpg::GraspConfig_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gpg::GraspConfig_<ContainerAllocator>& v)
  {
    s << indent << "position: ";
    s << std::endl;
...
#endif // GPG_MESSAGE_GRASPCONFIG_H
